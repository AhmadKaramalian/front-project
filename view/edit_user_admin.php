...
<html lang="fa">
 ...
 <form action="" method="post">
    ...
    <input type="radio" id="admin" name="type" value="2" <?php if(isset($row['type'])&& ($row['type'])=="2" ) echo 'checked'; ?> >  
    <br>
    <label for="member"> عادی </label> 
    <input type="radio" id="member" name="type" value="1" <?php if(isset($row['type'])&&($row['type'])=="1") echo 'checked'; ?>  ></div>   
    <br>
